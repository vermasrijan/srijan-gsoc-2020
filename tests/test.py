...
print("SEARCHED NODES: ".format(data.keys()))
...
# cmd = ['docker', 'rm', '$(docker', 'stop', '$(docker', 'ps', '-a', '-q', '--filter', 'ancestor=srijanverma44/grid-node:v028', '--format="{{.ID}}"))']
# print('===========')
# p = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
# print('==<STOPPING DOCKER NODE IMAGE>==')
# out, error = p.communicate()
# print(out)
# print('===========')
# print(error)
# print('===========')
# time.sleep(2)
# cmd = ['docker', 'rm', '$(docker', 'stop', '$(docker', 'ps', '-a', '-q', '--filter', 'ancestor=srijanverma44/grid-network:v028', '--format="{{.ID}}"))']
# print('===========')
# p = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
# print('==<STOPPING DOCKER NODE IMAGE>==')
# out, error = p.communicate()
